...
import pymnet
from pymnet.net import MultiplexNetwork,MultilayerNetwork
...
def webplot(net, struct,outputfile=None, mult_layer =False):
    ...
    if multi_layer:
        ...
        netdatastr = multi_layer.write_mult(net, struct)
        return netdatastr
    else:
